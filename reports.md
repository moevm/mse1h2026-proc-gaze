...
1. Реализация REST-API на серверной части;
1. Реализация подключения к postgresql на серверной части;
1. Реализация предобработки входных видео на части трекинга;
1. Реализация определения вектора взгляда на основе видео веб-камеры;
